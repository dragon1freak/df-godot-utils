...
const LOCAL_CONFIG_PATH = "res://addons/winput_helper/plugin.cfg"

const DownloadDialogScene = preload("res://addons/winput_helper/views/download_dialog.tscn")
...
func _enter_tree():
	add_autoload_singleton("InputHelper", "res://addons/winput_helper/input_helper.gd")
